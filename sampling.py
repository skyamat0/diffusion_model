...
def langevin_step(state: torch.Tensor, score: Callable ,alpha: float) -> torch.Tensor:
    """
    Description:
...
def langevin_sampling(init_state: torch.Tensor, score: Callable, K: int) -> torch.Tensor:
    """
    Description:
